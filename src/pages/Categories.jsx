...
export const Categories = ({ category, setCategory }) => {
    ...
    useEffect(() => {
        if (category.toLowerCase() === 'all') {
            ...
            const filtered = data.filter(item => item.dateCategory.toLowerCase() === category.toLowerCase());
    ...
    return (
        <>
            <div className="category-div container max-w-[1200px] mx-auto my-16 px-5">
                <div className="category-header flex flex-col gap-5">
                    ...
                    <div className="filter-btns-div">
                        <ul className="filter-btn-list flex w-full items-center justify-center gap-3" style={ { fontSize: 'smaller' } }>
                            <li
                                className="filter-btn border-2 border-gray-300 hover:border-gray-600 py-1 px-3 cursor-pointer"
                                onClick={ handleFilterClick }>All</li>
                            <li
                                className="filter-btn border-2 border-gray-300 py-1 px-3 cursor-pointer"
                ...
                <div className="content grid grid-cols-4 gap-5" style={ { marginTop: '4rem', marginBottom: '8rem' } }>
                    {
